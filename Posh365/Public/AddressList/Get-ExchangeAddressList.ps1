    ...
    process {
        foreach ($AList in $AddressList) {
            $List = New-Object -TypeName PSObject -Property @{
                ...
                ConditionalCustomAttribute2  = @($AList.ConditionalCustomAttribute1) -ne '' -join '|'
                ConditionalCustomAttribute3  = @($AList.ConditionalCustomAttribute1) -ne '' -join '|'
                ConditionalCustomAttribute4  = @($AList.ConditionalCustomAttribute1) -ne '' -join '|'
                ConditionalCustomAttribute5  = @($AList.ConditionalCustomAttribute1) -ne '' -join '|'
                ConditionalCustomAttribute6  = @($AList.ConditionalCustomAttribute1) -ne '' -join '|'
                ConditionalCustomAttribute7  = @($AList.ConditionalCustomAttribute1) -ne '' -join '|'
                ConditionalCustomAttribute8  = @($AList.ConditionalCustomAttribute1) -ne '' -join '|'
                ConditionalCustomAttribute9  = @($AList.ConditionalCustomAttribute1) -ne '' -join '|'
                ConditionalCustomAttribute10 = @($AList.ConditionalCustomAttribute1) -ne '' -join '|'
                ConditionalCustomAttribute11 = @($AList.ConditionalCustomAttribute1) -ne '' -join '|'
                ConditionalCustomAttribute12 = @($AList.ConditionalCustomAttribute1) -ne '' -join '|'
                ConditionalCustomAttribute13 = @($AList.ConditionalCustomAttribute1) -ne '' -join '|'
                ConditionalCustomAttribute14 = @($AList.ConditionalCustomAttribute1) -ne '' -join '|'
                ConditionalCustomAttribute15 = @($AList.ConditionalCustomAttribute1) -ne '' -join '|'
