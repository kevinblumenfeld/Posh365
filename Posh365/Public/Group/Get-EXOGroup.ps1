function Get-EXOGroup { 
    ...
    .EXAMPLE
    Get-DistributionGroup -Filter "emailaddresses -like '*contoso.com*'" | Select -ExpandProperty Name | Get-EXOGroup | Export-Csv c:\scripts\365GroupExport.csv -notypeinformation -encoding UTF8
